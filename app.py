...
# # Configuration
# API_KEY = "69b9d510de193690c30b59bc5f8e58f3"  # Replace with your OpenWeatherMap API key
...
#         return jsonify({
#             'error': 'API key not configured. Please set your OpenWeatherMap API key.'
#         }), 500
...
#             'icon_url': ICON_URL.format(data['weather'][0]['icon']),
#             'timestamp': data['dt'],
...
#                 'icon_url': ICON_URL.format(item['weather'][0]['icon']),
...
# @app.route('/api/weather/dashboard', methods=['GET'])
...
#     print("=" * 50)
#     print("Weather Forecast API Backend")
#     print("=" * 50)
